...
export const projects: Project[] = [
  {
    ...
    featured: true,
    tags: [TAGS.vue, TAGS.vite, TAGS.vuetify, TAGS.aws, TAGS.opsc, TAGS.spa, TAGS.mobile],
    description:
  ...
  },
  {
    ...
    featured: true,
    tags: [TAGS.vue, TAGS.vite, TAGS.vuetify, TAGS.python, TAGS.opsc, TAGS.spa, TAGS.mobile],
    description:
  ...
  },
  {
    ...
    tags: [TAGS.vue, TAGS.vite, TAGS.vuetify, TAGS.python, TAGS.spa, TAGS.mobile, TAGS.opsc],
    description:
  ...
  },
  {
    ...
    sourceUri: "",
    tags: [TAGS.vue, TAGS.vite, TAGS.vuetify, TAGS.spa, TAGS.aws, TAGS.professional],
    description: "A static web app to help sales reps calculate the cost of an irrigation system.",
  },
  {
